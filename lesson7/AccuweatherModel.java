        ...
        switch (period) {
            case NOW:
                ...
                WeatherResponse weather1 = new WeatherResponse(
                        objectMapper.readTree(weatherResponse1).at("/DailyForecasts").get(0).at("/Date").asText(),
            ...
            case FIVE_DAYS:
                ...
                for (int i = 0; i < 5; i++) {
                    weather5[i] = new WeatherResponse(
                            objectMapper.readTree(weatherResponse5).at("/DailyForecasts").get(i).at("/Date").asText().substring(1, 10),
